...
export const AegisAIInteraction = () => {
  ...
  return (
    <>
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="max-w-2xl mx-auto mb-12">
            <Button 
              ...
              size="lg"
              className="bg-white text-purple-600 hover:bg-gray-100 px-12 py-6 text-xl font-bold rounded-full shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-105"
            >
              Talk to{" "}
              <a 
                href="https://AegisWhistle.com" 
      ...
      {/* Iframe Popup */}
      {showIframe && (
        <div className="fixed inset-0 z-[999999999] bg-black bg-opacity-50 flex items-center justify-center p-4">
          <div className="relative w-full max-w-7xl h-full max-h-[90vh] bg-transparent">
            {/* Close button */}
            <button
              onClick={handleCloseIframe}
              className="absolute -top-12 right-0 z-[9999999999] bg-white text-gray-800 hover:bg-gray-100 rounded-full p-2 shadow-lg transition-all duration-200"
            >
              <X className="w-6 h-6" />
            </button>
